export class InputSystem {
    ...
    static initialize(canvas) {
        ...
        canvas.addEventListener(
            "contextmenu",
            InputSystem.#handlers.contextMenu,
        );
    ...
    static dispose() {
        ...
        window.removeEventListener(
            "keydown",
            InputSystem.#handlers.keyDown,
        );

        window.removeEventListener(
            "keyup",
            InputSystem.#handlers.keyUp,
        );

        window.removeEventListener(
            "mouseup",
            InputSystem.#handlers.mouseUp,
        );
        ...
        InputSystem.#canvas.removeEventListener(
            "mousedown",
            InputSystem.#handlers.mouseDown,
        );

        InputSystem.#canvas.removeEventListener(
            "mousemove",
            InputSystem.#handlers.mouseMove,
        );

        InputSystem.#canvas.removeEventListener(
            "wheel",
            InputSystem.#handlers.wheel,
        );
